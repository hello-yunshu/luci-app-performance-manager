...
def main() -> int:
    ...
    manifest = {
        ...
        "artifactName": f'{adapter["binary"]}-{os.environ.get("RUST_TARGET", "x86_64-unknown-linux-musl")}',
        "packageArch": os.environ.get("PACKAGE_ARCH", "x86_64"),
        "rustTarget": os.environ.get("RUST_TARGET", "x86_64-unknown-linux-musl"),
        "artifactSha256": None,
        "artifactSize": None,
        "status": "pm-owned",
