# Source Audit — 1.0.0-rc.11

## Decision

**PASS — 1.0.0-rc.11 source candidate PASS; functional integration and Stable release are NOT_EVALUATED.**
...
- Executable unit/contract tests: **171**, status **PASS**.
