...
return view.extend({
	...
	render: function(payload) {
		...
		const feedbackTable = E('table', { 'class': 'table pm-ranking-table' }, [ E('thead', {}, [ E('tr', {}, [ E('th', {}, [ _('Action') ]), E('th', {}, [ _('Goal') ]), E('th', {}, [ _('Reward') ]), E('th', {}, [ _('Quality') ]), E('th', {}, [ _('Result') ]) ]) ]), E('tbody', {}, feedbackRows) ]);
		return pu.page(_('RillML (Rill) Intelligence'), _('Rill ranks legal actions while Core keeps the final execution authority.'), [
			pu.card(_('Runtime status'), pu.kv([
				[_('State'), r.status || _('Runtime · Collecting')], [_('Version'), r.rillVersion || r.resolvedRillVersion || '—'], [_('Transport'), r.transport || '—'], [_('Runtime contract'), r.protocolVersion == null ? '—' : 'Runtime v' + r.protocolVersion], [_('Last decision'), s.decisionId || '—'], [_('Last outcome'), s.lastOutcome ? JSON.stringify(s.lastOutcome) : '—']
			]), 'hero'),
			...
			pu.card(_('Learning status'), pu.kv([
				[_('Learning stage'), s.learningStage || _('cold')], [_('Validated samples'), s.validatedSamples == null ? '0' : String(s.validatedSamples)], [_('Minimum samples'), s.minimumSamples == null ? '—' : String(s.minimumSamples)], [_('Confidence'), s.confidence == null ? '—' : String(s.confidence)], [_('Last reward'), s.lastReward == null ? '—' : String(s.lastReward)], [_('Drift'), s.drifted ? _('Detected') : _('Stable')], [_('Auto eligibility'), s.autoEligible === false ? _('Paused') : (s.reason || _('Eligible'))]
			]), 'muted'),
